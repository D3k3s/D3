...
public class Systems {
    ...
    public static void init() {
        ...
        D3.EVENT_BUS.subscribe(Systems.class);
    }

    public static System<?> add(System<?> system) {
        systems.put(system.getClass(), system);
        D3.EVENT_BUS.subscribe(system);
        system.init();
    ...
    public static void save(File folder) {
        ...
        D3.LOG.info("Saved in {} milliseconds.", java.lang.System.currentTimeMillis() - start);
    }
    ...
    public static void load(File folder) {
        ...
        D3.LOG.info("Loaded in {} milliseconds", java.lang.System.currentTimeMillis() - start);
    }
